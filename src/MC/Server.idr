...
export data Array_String : Type where [external]
...
export data BlockLocationIterator : Type where [external]
export data BlockPistonComponent : Type where [external]
export data Array_Vector3 : Type where [external]
...
export data Array_BlockStateType : Type where [external]
export data Array_UniverseUnion : Type where [external]
export data BlockTypes : Type where [external]
export data Array_BlockType : Type where [external]
...
export data Array_Player : Type where [external]
...
export data Array_DefinitionModifier : Type where [external]
...
export data Array_Trigger : Type where [external]
...
export data Array_Entity : Type where [external]
export data EntityRaycastOptions : Type where [external]
export data Array_EntityRaycastHit : Type where [external]
...
export data Array_DimensionType : Type where [external]
...
export data Array_EffectType : Type where [external]
...
export data Array_EntityComponent : Type where [external]
export data Array_Effect : Type where [external]
...
export data Array_EntityDefinitionFeedItem : Type where [external]
...
export data Array_BlockPermutation : Type where [external]
...
export data Array_FeedItem : Type where [external]
...
export data EntityIterator : Type where [external]
...
export data Array_Seat : Type where [external]
...
export data EntityTypeIterator : Type where [external]
...
export data Array_FeedItemEffect : Type where [external]
...
export data Array_ItemComponent : Type where [external]
...
export data ItemTypeIterator : Type where [external]
...
export data PlayerIterator : Type where [external]
...
export data Array_ScoreboardObjective : Type where [external]
export data Array_ScoreboardIdentity : Type where [external]
export data Array_ScoreboardScoreInfo : Type where [external]
...
export data BlockVolumeIntersection : Type where [external]
export data CompoundBlockVolumeAction : Type where [external]
export data Direction : Type where [external]
export data DisplaySlotId : Type where [external]
export data DyeColor : Type where [external]
export data EasingType : Type where [external]
export data EntityDamageCause : Type where [external]
export data EntityLifetimeState : Type where [external]
export data EquipmentSlot : Type where [external]
export data FluidType : Type where [external]
export data GameMode : Type where [external]
export data ItemLockMode : Type where [external]
export data MoonPhase : Type where [external]
export data ObjectiveSortOrder : Type where [external]
export data ScoreboardIdentityType : Type where [external]
export data ScriptEventSource : Type where [external]
export data SignSide : Type where [external]
export data TimeOfDay : Type where [external]
export data WatchdogTerminateReason : Type where [external]
export data WeatherType : Type where [external]
namespace Block
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.canPlace($1,$2)"
	canPlace: Block -> String -> UniverseUnion -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getComponent($1)"
	getComponent: Block -> String -> BlockComponent
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.getItemStack($1,$2)"
	getItemStack: Block -> Double -> Bool -> ItemStack
	export
	%foreign "javascript:lambda: ($0) => $0.getRedstonePower()"
	getRedstonePower: Block -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getTags()"
	getTags: Block -> Array_String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasTag($1)"
	hasTag: Block -> String -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isAir()"
	isAir: Block -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isLiquid()"
	isLiquid: Block -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isSolid()"
	isSolid: Block -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: Block -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setPermutation($1)"
	setPermutation: Block -> BlockPermutation -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setType($1)"
	setType: Block -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.trySetPermutation($1)"
	trySetPermutation: Block -> BlockPermutation -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.dimension"
	dimension: Block -> Dimension
	export
	%foreign "javascript:lambda: ($0) => $0.isWaterlogged"
	isWaterlogged: Block -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.isWaterlogged = $1"
	set_isWaterlogged: Block -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.location"
	location: Block -> Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.permutation"
	permutation: Block -> BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.type"
	type: Block -> BlockType
	export
	%foreign "javascript:lambda: ($0) => $0.typeId"
	typeId: Block -> String
	export
	%foreign "javascript:lambda: ($0) => $0.x"
	x: Block -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.y"
	y: Block -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.z"
	z: Block -> Double

namespace BlockAreaSize
	export
	%foreign "javascript:lambda: ($0,$1,$2) => new BlockAreaSize($1,$2)"
	MkBlockAreaSize: Double -> Double -> Double -> BlockAreaSize
	export
	%foreign "javascript:lambda: ($0,$1) => $0.equals($1)"
	equals: BlockAreaSize -> BlockAreaSize -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.x"
	x: BlockAreaSize -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.x = $1"
	set_x: BlockAreaSize -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.y"
	y: BlockAreaSize -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.y = $1"
	set_y: BlockAreaSize -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.z"
	z: BlockAreaSize -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.z = $1"
	set_z: BlockAreaSize -> Double -> PrimIO ()

namespace BlockBreakAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.brokenBlockPermutation"
	brokenBlockPermutation: BlockBreakAfterEvent -> BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.player"
	player: BlockBreakAfterEvent -> Player

namespace BlockBreakAfterEventSignal
	export
	%foreign "javascript:lambda: ($0,$1) => $0.subscribe($1)"
	subscribe: BlockBreakAfterEventSignal -> (BlockBreakAfterEvent -> IO ()) -> (BlockBreakAfterEvent -> IO ())
	export
	%foreign "javascript:lambda: ($0,$1) => $0.unsubscribe($1)"
	unsubscribe: BlockBreakAfterEventSignal -> (BlockBreakAfterEvent -> IO ()) -> IO ()

namespace BlockComponent
	export
	%foreign "javascript:lambda: ($0) => $0.block"
...
namespace BlockExplodeAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.explodedBlockPermutation"
	explodedBlockPermutation: BlockExplodeAfterEvent -> BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.source"
...
namespace BlockInventoryComponent
	export
	%foreign "javascript:lambda: ($0) => $0.container"
	container: BlockInventoryComponent -> Container

namespace BlockLiquidContainerComponent
	export
	%foreign "javascript:lambda: ($0) => $0.isValidLiquid()"
	isValidLiquid: BlockLiquidContainerComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.fillLevel"
	fillLevel: BlockLiquidContainerComponent -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.fillLevel = $1"
	set_fillLevel: BlockLiquidContainerComponent -> Double -> PrimIO ()

namespace BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.clone()"
	clone: BlockPermutation -> BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.getAllStates()"
	getAllStates: BlockPermutation -> Record
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getItemStack($1)"
	getItemStack: BlockPermutation -> Double -> ItemStack
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getState($1)"
	getState: BlockPermutation -> String -> String
	export
	%foreign "javascript:lambda: ($0) => $0.getTags()"
	getTags: BlockPermutation -> Array_String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasTag($1)"
	hasTag: BlockPermutation -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.matches($1,$2)"
	matches: BlockPermutation -> String -> Record -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.withState($1,$2)"
	withState: BlockPermutation -> String -> String -> BlockPermutation
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.resolve($1,$2)"
	resolve: BlockPermutation -> String -> Record -> BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.type"
...
namespace BlockPistonComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getAttachedBlocks()"
	getAttachedBlocks: BlockPistonComponent -> Array_Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.isExpanded"
	isExpanded: BlockPistonComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isExpanding"
	isExpanding: BlockPistonComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isMoving"
	isMoving: BlockPistonComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isRetracted"
	isRetracted: BlockPistonComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isRetracting"
	isRetracting: BlockPistonComponent -> Bool
...
namespace BlockPotionContainerComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setPotionType($1)"
	setPotionType: BlockPotionContainerComponent -> ItemStack -> IO ()

namespace BlockRecordPlayerComponent
	export
	%foreign "javascript:lambda: ($0) => $0.clearRecord()"
	clearRecord: BlockRecordPlayerComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.isPlaying()"
	isPlaying: BlockRecordPlayerComponent -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setRecord($1)"
	setRecord: BlockRecordPlayerComponent -> ItemType -> IO ()

namespace BlockSignComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getRawText($1)"
	getRawText: BlockSignComponent -> UniverseUnion -> RawText
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getText($1)"
	getText: BlockSignComponent -> UniverseUnion -> String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getTextDyeColor($1)"
	getTextDyeColor: BlockSignComponent -> UniverseUnion -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setText($1,$2)"
	setText: BlockSignComponent -> String -> UniverseUnion -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setTextDyeColor($1,$2)"
	setTextDyeColor: BlockSignComponent -> UniverseUnion -> UniverseUnion -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.setWaxed()"
	setWaxed: BlockSignComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.isWaxed"
	isWaxed: BlockSignComponent -> Bool

namespace BlockStates
	export
	%foreign "javascript:lambda: ($0,$1) => $0.get($1)"
	get: BlockStates -> String -> BlockStateType
	export
	%foreign "javascript:lambda: ($0) => $0.getAll()"
	getAll: BlockStates -> Array_BlockStateType

namespace BlockStateType
	export
	%foreign "javascript:lambda: ($0) => $0.id"
	id: BlockStateType -> String
	export
	%foreign "javascript:lambda: ($0) => $0.validValues"
	validValues: BlockStateType -> Array_UniverseUnion

namespace BlockType
	export
	%foreign "javascript:lambda: ($0) => $0.canBeWaterlogged"
	canBeWaterlogged: BlockType -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.id"
	id: BlockType -> String
...
namespace BlockTypes
	...
	export
	%foreign "javascript:lambda: ($0) => $0.getAll()"
	getAll: BlockTypes -> Array_BlockType

namespace BlockVolumeUtils
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.doesLocationTouchFaces($1,$2)"
	doesLocationTouchFaces: BlockVolumeUtils -> BlockVolume -> Vector3 -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.doesVolumeTouchFaces($1,$2)"
	doesVolumeTouchFaces: BlockVolumeUtils -> BlockVolume -> BlockVolume -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.equals($1,$2)"
	equals: BlockVolumeUtils -> BlockVolume -> BlockVolume -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getBlockLocationIterator($1)"
	getBlockLocationIterator: BlockVolumeUtils -> BlockVolume -> BlockLocationIterator
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getBoundingBox($1)"
	getBoundingBox: BlockVolumeUtils -> BlockVolume -> BoundingBox
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getCapacity($1)"
	getCapacity: BlockVolumeUtils -> BlockVolume -> Double
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getMax($1)"
	getMax: BlockVolumeUtils -> BlockVolume -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getMin($1)"
	getMin: BlockVolumeUtils -> BlockVolume -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getSpan($1)"
	getSpan: BlockVolumeUtils -> BlockVolume -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.intersects($1,$2)"
	intersects: BlockVolumeUtils -> BlockVolume -> BlockVolume -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.isInside($1,$2)"
	isInside: BlockVolumeUtils -> BlockVolume -> Vector3 -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.translate($1,$2)"
	translate: BlockVolumeUtils -> BlockVolume -> Vector3 -> BlockVolume

namespace BlockWaterContainerComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addDye($1)"
	addDye: BlockWaterContainerComponent -> ItemType -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.getCustomColor()"
	getCustomColor: BlockWaterContainerComponent -> Color
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setCustomColor($1)"
	setCustomColor: BlockWaterContainerComponent -> Color -> IO ()

namespace BoundingBoxUtils
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.createValid($1,$2)"
	createValid: BoundingBoxUtils -> Vector3 -> Vector3 -> BoundingBox
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.dilate($1,$2)"
	dilate: BoundingBoxUtils -> BoundingBox -> Vector3 -> BoundingBox
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.equals($1,$2)"
	equals: BoundingBoxUtils -> BoundingBox -> BoundingBox -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.expand($1,$2)"
	expand: BoundingBoxUtils -> BoundingBox -> BoundingBox -> BoundingBox
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getCenter($1)"
	getCenter: BoundingBoxUtils -> BoundingBox -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.getIntersection($1,$2)"
	...
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.intersects($1,$2)"
	intersects: BoundingBoxUtils -> BoundingBox -> BoundingBox -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.isInside($1,$2)"
	isInside: BoundingBoxUtils -> BoundingBox -> Vector3 -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.isValid($1)"
	isValid: BoundingBoxUtils -> BoundingBox -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.translate($1,$2)"
...
namespace Camera
	export
	%foreign "javascript:lambda: ($0) => $0.clear()"
	clear: Camera -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.fade($1)"
	fade: Camera -> CameraFadeOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setCamera($1,$2)"
	setCamera: Camera -> String -> UniverseUnion -> IO ()

namespace ChatSendAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.getTargets()"
	getTargets: ChatSendAfterEvent -> Array_Player
	export
	%foreign "javascript:lambda: ($0) => $0.message"
	message: ChatSendAfterEvent -> String
	export
	%foreign "javascript:lambda: ($0, $1) => $0.message = $1"
	set_message: ChatSendAfterEvent -> String -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.sender"
	sender: ChatSendAfterEvent -> Player
	export
	%foreign "javascript:lambda: ($0, $1) => $0.sender = $1"
	set_sender: ChatSendAfterEvent -> Player -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.sendToTargets"
	sendToTargets: ChatSendAfterEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.sendToTargets = $1"
	set_sendToTargets: ChatSendAfterEvent -> Bool -> PrimIO ()

namespace ChatSendAfterEventSignal
	export
	%foreign "javascript:lambda: ($0,$1) => $0.subscribe($1)"
	subscribe: ChatSendAfterEventSignal -> (ChatSendAfterEvent -> IO ()) -> IO ()
...
namespace ChatSendBeforeEvent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setTargets($1)"
	setTargets: ChatSendBeforeEvent -> Array_Player -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: ChatSendBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: ChatSendBeforeEvent -> Bool -> PrimIO ()
...
namespace CommandResult
	export
	%foreign "javascript:lambda: ($0) => $0.successCount"
...
namespace CompoundBlockVolume
	...
	export
	%foreign "javascript:lambda: ($0) => $0.getBlockLocationIterator()"
	getBlockLocationIterator: CompoundBlockVolume -> BlockLocationIterator
	export
	%foreign "javascript:lambda: ($0) => $0.getBoundingBox()"
	getBoundingBox: CompoundBlockVolume -> BoundingBox
	export
	%foreign "javascript:lambda: ($0) => $0.getMax()"
	getMax: CompoundBlockVolume -> Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.getMin()"
	getMin: CompoundBlockVolume -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1) => $0.isInside($1)"
	isInside: CompoundBlockVolume -> Vector3 -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.peekLastVolume()"
	peekLastVolume: CompoundBlockVolume -> CompoundBlockVolumeItem
	export
	%foreign "javascript:lambda: ($0) => $0.popVolume()"
	popVolume: CompoundBlockVolume -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.pushVolume($1)"
	pushVolume: CompoundBlockVolume -> CompoundBlockVolumeItem -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.replaceOrAddLastVolume($1)"
	replaceOrAddLastVolume: CompoundBlockVolume -> CompoundBlockVolumeItem -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.translate($1)"
	translate: CompoundBlockVolume -> Vector3 -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.capacity"
	capacity: CompoundBlockVolume -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.volumeCount"
	volumeCount: CompoundBlockVolume -> Double

namespace Container
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addItem($1)"
	addItem: Container -> ItemStack -> ItemStack
	export
	%foreign "javascript:lambda: ($0) => $0.clearAll()"
	clearAll: Container -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getItem($1)"
	getItem: Container -> Double -> ItemStack
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getSlot($1)"
	getSlot: Container -> Double -> ContainerSlot
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: Container -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.moveItem($1,$2,$3)"
	moveItem: Container -> Double -> Double -> Container -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setItem($1,$2)"
	setItem: Container -> Double -> ItemStack -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.swapItems($1,$2,$3)"
	swapItems: Container -> Double -> Double -> Container -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.transferItem($1,$2)"
	transferItem: Container -> Double -> Container -> ItemStack
	export
	%foreign "javascript:lambda: ($0) => $0.emptySlotsCount"
	emptySlotsCount: Container -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.size"
	size: Container -> Double

namespace ContainerSlot
	export
	%foreign "javascript:lambda: ($0) => $0.getItem()"
	getItem: ContainerSlot -> ItemStack
	export
	%foreign "javascript:lambda: ($0) => $0.getLore()"
	getLore: ContainerSlot -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getTags()"
	getTags: ContainerSlot -> Array_String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasTag($1)"
	hasTag: ContainerSlot -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.isStackableWith($1)"
	isStackableWith: ContainerSlot -> ItemStack -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: ContainerSlot -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setCanDestroy($1)"
	setCanDestroy: ContainerSlot -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setCanPlaceOn($1)"
	setCanPlaceOn: ContainerSlot -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setItem($1)"
	setItem: ContainerSlot -> ItemStack -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setLore($1)"
	setLore: ContainerSlot -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.amount"
	amount: ContainerSlot -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.amount = $1"
	set_amount: ContainerSlot -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.isStackable"
	isStackable: ContainerSlot -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.keepOnDeath"
	keepOnDeath: ContainerSlot -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.keepOnDeath = $1"
	set_keepOnDeath: ContainerSlot -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.lockMode"
	lockMode: ContainerSlot -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0, $1) => $0.lockMode = $1"
	set_lockMode: ContainerSlot -> UniverseUnion -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.maxAmount"
	maxAmount: ContainerSlot -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.nameTag"
	nameTag: ContainerSlot -> String
	export
	%foreign "javascript:lambda: ($0, $1) => $0.nameTag = $1"
	set_nameTag: ContainerSlot -> String -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.type"
...
namespace DataDrivenEntityTriggerAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.getModifiers()"
	getModifiers: DataDrivenEntityTriggerAfterEvent -> Array_DefinitionModifier
	export
	%foreign "javascript:lambda: ($0) => $0.entity"
...
namespace DataDrivenEntityTriggerAfterEventSignal
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.subscribe($1,$2)"
...
namespace DataDrivenEntityTriggerBeforeEvent
	export
	%foreign "javascript:lambda: ($0) => $0.getModifiers()"
	getModifiers: DataDrivenEntityTriggerBeforeEvent -> Array_DefinitionModifier
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setModifiers($1)"
	setModifiers: DataDrivenEntityTriggerBeforeEvent -> Array_DefinitionModifier -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: DataDrivenEntityTriggerBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: DataDrivenEntityTriggerBeforeEvent -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.entity"
...
namespace DefinitionModifier
	export
	%foreign "javascript:lambda: ($0) => $0.getComponentGroupsToAdd()"
	getComponentGroupsToAdd: DefinitionModifier -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getComponentGroupsToRemove()"
	getComponentGroupsToRemove: DefinitionModifier -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getTriggers()"
	getTriggers: DefinitionModifier -> Array_Trigger
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setComponentGroupsToAdd($1)"
	setComponentGroupsToAdd: DefinitionModifier -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setComponentGroupsToRemove($1)"
	setComponentGroupsToRemove: DefinitionModifier -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setTriggers($1)"
	setTriggers: DefinitionModifier -> Array_Trigger -> IO ()

namespace Dimension
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.createExplosion($1,$2,$3)"
	createExplosion: Dimension -> Vector3 -> Double -> ExplosionOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3,$4) => $0.fillBlocks($1,$2,$3,$4)"
	fillBlocks: Dimension -> Vector3 -> Vector3 -> String -> BlockFillOptions -> Double
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getBlock($1)"
	getBlock: Dimension -> Vector3 -> Block
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.getBlockFromRay($1,$2,$3)"
	getBlockFromRay: Dimension -> Vector3 -> Vector3 -> BlockRaycastOptions -> BlockRaycastHit
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEntities($1)"
	getEntities: Dimension -> EntityQueryOptions -> Array_Entity
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEntitiesAtBlockLocation($1)"
	getEntitiesAtBlockLocation: Dimension -> Vector3 -> Array_Entity
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.getEntitiesFromRay($1,$2,$3)"
	getEntitiesFromRay: Dimension -> Vector3 -> Vector3 -> EntityRaycastOptions -> Array_EntityRaycastHit
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getPlayers($1)"
	getPlayers: Dimension -> EntityQueryOptions -> Array_Player
	export
	%foreign "javascript:lambda: ($0,$1) => $0.runCommand($1)"
	runCommand: Dimension -> String -> CommandResult
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setWeather($1)"
	setWeather: Dimension -> UniverseUnion -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.spawnEntity($1,$2)"
	spawnEntity: Dimension -> String -> Vector3 -> Entity
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.spawnItem($1,$2)"
	spawnItem: Dimension -> ItemStack -> Vector3 -> Entity
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.spawnParticle($1,$2,$3)"
...
namespace DimensionTypes
	...
	export
	%foreign "javascript:lambda: ($0) => $0.getAll()"
	getAll: DimensionTypes -> Array_DimensionType

namespace DynamicPropertiesDefinition
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.defineBoolean($1,$2)"
	defineBoolean: DynamicPropertiesDefinition -> String -> Bool -> DynamicPropertiesDefinition
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.defineNumber($1,$2)"
	defineNumber: DynamicPropertiesDefinition -> String -> Double -> DynamicPropertiesDefinition
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.defineString($1,$2,$3)"
	defineString: DynamicPropertiesDefinition -> String -> Double -> String -> DynamicPropertiesDefinition
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.defineVector($1,$2)"
...
namespace Effect
	...
	isValid: Effect -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.amplifier"
	amplifier: Effect -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.displayName"
	displayName: Effect -> String
	export
	%foreign "javascript:lambda: ($0) => $0.duration"
...
namespace EffectAddAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.effect"
	effect: EffectAddAfterEvent -> Effect
	export
	%foreign "javascript:lambda: ($0, $1) => $0.effect = $1"
	set_effect: EffectAddAfterEvent -> Effect -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.effectState"
	effectState: EffectAddAfterEvent -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.effectState = $1"
	set_effectState: EffectAddAfterEvent -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.entity"
	entity: EffectAddAfterEvent -> Entity
	export
	%foreign "javascript:lambda: ($0, $1) => $0.entity = $1"
	set_entity: EffectAddAfterEvent -> Entity -> PrimIO ()
...
namespace EffectType
	export
	%foreign "javascript:lambda: ($0) => $0.getName()"
...
namespace EffectTypes
	...
	export
	%foreign "javascript:lambda: ($0) => $0.getAll()"
	getAll: EffectTypes -> Array_EffectType

namespace Enchantment
	export
	%foreign "javascript:lambda: ($0,$1) => new Enchantment($1)"
	MkEnchantment: String -> Double -> Enchantment
	export
	%foreign "javascript:lambda: ($0) => $0.level"
	level: Enchantment -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.level = $1"
	set_level: Enchantment -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.type"
...
namespace EnchantmentList
	export
	%foreign "javascript:lambda: ($0) => new EnchantmentList()"
	MkEnchantmentList: Double -> EnchantmentList
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addEnchantment($1)"
	addEnchantment: EnchantmentList -> Enchantment -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.canAddEnchantment($1)"
	canAddEnchantment: EnchantmentList -> Enchantment -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEnchantment($1)"
	getEnchantment: EnchantmentList -> String -> Enchantment
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasEnchantment($1)"
	hasEnchantment: EnchantmentList -> String -> Double
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeEnchantment($1)"
	removeEnchantment: EnchantmentList -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.slot"
...
namespace EnchantmentType
	...
	export
	%foreign "javascript:lambda: ($0) => $0.maxLevel"
...
namespace Entity
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.addEffect($1,$2,$3)"
	addEffect: Entity -> String -> Double -> EntityEffectOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addTag($1)"
	addTag: Entity -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.applyDamage($1,$2)"
	applyDamage: Entity -> Double -> UniverseUnion -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.applyImpulse($1)"
	applyImpulse: Entity -> Vector3 -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3,$4) => $0.applyKnockback($1,$2,$3,$4)"
	applyKnockback: Entity -> Double -> Double -> Double -> Double -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.clearVelocity()"
	clearVelocity: Entity -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.extinguishFire($1)"
	extinguishFire: Entity -> Bool -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getBlockFromViewDirection($1)"
	getBlockFromViewDirection: Entity -> BlockRaycastOptions -> BlockRaycastHit
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getComponent($1)"
	getComponent: Entity -> String -> EntityComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getComponents()"
	getComponents: Entity -> Array_EntityComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getDynamicProperty($1)"
	getDynamicProperty: Entity -> String -> String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEffect($1)"
	getEffect: Entity -> String -> Effect
	export
	%foreign "javascript:lambda: ($0) => $0.getEffects()"
	getEffects: Entity -> Array_Effect
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEntitiesFromViewDirection($1)"
	getEntitiesFromViewDirection: Entity -> EntityRaycastOptions -> Array_EntityRaycastHit
	export
	%foreign "javascript:lambda: ($0) => $0.getHeadLocation()"
	getHeadLocation: Entity -> Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.getRotation()"
	getRotation: Entity -> Vector2
	export
	%foreign "javascript:lambda: ($0) => $0.getTags()"
	getTags: Entity -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getVelocity()"
	getVelocity: Entity -> Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.getViewDirection()"
	getViewDirection: Entity -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasComponent($1)"
	hasComponent: Entity -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasTag($1)"
	hasTag: Entity -> String -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.kill()"
	kill: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.playAnimation($1,$2)"
	playAnimation: Entity -> String -> PlayAnimationOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeDynamicProperty($1)"
	removeDynamicProperty: Entity -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeEffect($1)"
	removeEffect: Entity -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeTag($1)"
	removeTag: Entity -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.runCommand($1)"
	runCommand: Entity -> String -> CommandResult
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setDynamicProperty($1,$2)"
	setDynamicProperty: Entity -> String -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setOnFire($1,$2)"
	setOnFire: Entity -> Double -> Bool -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setRotation($1)"
	setRotation: Entity -> Vector2 -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.teleport($1,$2)"
	teleport: Entity -> Vector3 -> TeleportOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.triggerEvent($1)"
	triggerEvent: Entity -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.tryTeleport($1,$2)"
	tryTeleport: Entity -> Vector3 -> TeleportOptions -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.dimension"
	dimension: Entity -> Dimension
	export
	%foreign "javascript:lambda: ($0) => $0.fallDistance"
	fallDistance: Entity -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.id"
	id: Entity -> String
	export
	%foreign "javascript:lambda: ($0) => $0.isClimbing"
	isClimbing: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isFalling"
	isFalling: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isInWater"
	isInWater: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isOnGround"
	isOnGround: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isSneaking"
	isSneaking: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.isSneaking = $1"
	set_isSneaking: Entity -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.isSprinting"
	isSprinting: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isSwimming"
	isSwimming: Entity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.lifetimeState"
	lifetimeState: Entity -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0) => $0.location"
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.nameTag = $1"
	set_nameTag: Entity -> String -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.scoreboardIdentity"
	scoreboardIdentity: Entity -> ScoreboardIdentity
	export
	%foreign "javascript:lambda: ($0) => $0.target"
...
namespace EntityAddRiderComponent
	export
	%foreign "javascript:lambda: ($0) => $0.entityType"
	entityType: EntityAddRiderComponent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.spawnEvent"
	spawnEvent: EntityAddRiderComponent -> String

namespace EntityAgeableComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getDropItems()"
	getDropItems: EntityAgeableComponent -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getFeedItems()"
	getFeedItems: EntityAgeableComponent -> Array_EntityDefinitionFeedItem
	export
	%foreign "javascript:lambda: ($0) => $0.duration"
	duration: EntityAgeableComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.growUp"
	growUp: EntityAgeableComponent -> Trigger

namespace EntityAttributeComponent
	export
	%foreign "javascript:lambda: ($0) => $0.resetToDefaultValue()"
	resetToDefaultValue: EntityAttributeComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.resetToMaxValue()"
	resetToMaxValue: EntityAttributeComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.resetToMinValue()"
	resetToMinValue: EntityAttributeComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setCurrentValue($1)"
	setCurrentValue: EntityAttributeComponent -> Double -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.currentValue"
	currentValue: EntityAttributeComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.defaultValue"
	defaultValue: EntityAttributeComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.effectiveMax"
	effectiveMax: EntityAttributeComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.effectiveMin"
	effectiveMin: EntityAttributeComponent -> Double

namespace EntityBaseMovementComponent
	export
	%foreign "javascript:lambda: ($0) => $0.maxTurn"
	maxTurn: EntityBaseMovementComponent -> Double

namespace EntityBreathableComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getBreatheBlocks()"
	getBreatheBlocks: EntityBreathableComponent -> Array_BlockPermutation
	export
	%foreign "javascript:lambda: ($0) => $0.getNonBreatheBlocks()"
	getNonBreatheBlocks: EntityBreathableComponent -> Array_BlockPermutation
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setAirSupply($1)"
	setAirSupply: EntityBreathableComponent -> Double -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.breathesAir"
	breathesAir: EntityBreathableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.breathesLava"
	breathesLava: EntityBreathableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.breathesSolids"
	breathesSolids: EntityBreathableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.breathesWater"
	breathesWater: EntityBreathableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.generatesBubbles"
	generatesBubbles: EntityBreathableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.inhaleTime"
	inhaleTime: EntityBreathableComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.suffocateTime"
	suffocateTime: EntityBreathableComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.totalSupply"
	totalSupply: EntityBreathableComponent -> Double

namespace EntityColorComponent
	export
	%foreign "javascript:lambda: ($0) => $0.value"
	value: EntityColorComponent -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityColorComponent -> Double -> PrimIO ()
...
namespace EntityEquipmentInventoryComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEquipment($1)"
	getEquipment: EntityEquipmentInventoryComponent -> UniverseUnion -> ItemStack
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEquipmentSlot($1)"
	getEquipmentSlot: EntityEquipmentInventoryComponent -> UniverseUnion -> ContainerSlot
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setEquipment($1,$2)"
	setEquipment: EntityEquipmentInventoryComponent -> UniverseUnion -> ItemStack -> Bool
...
namespace EntityFlyingSpeedComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityFlyingSpeedComponent -> Double -> PrimIO ()
...
namespace EntityFrictionModifierComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityFrictionModifierComponent -> Double -> PrimIO ()
...
namespace EntityGroundOffsetComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityGroundOffsetComponent -> Double -> PrimIO ()

namespace EntityHealableComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getFeedItems()"
	getFeedItems: EntityHealableComponent -> Array_FeedItem
	export
	%foreign "javascript:lambda: ($0) => $0.filters"
	filters: EntityHealableComponent -> FilterGroup
	export
	%foreign "javascript:lambda: ($0) => $0.forceUse"
	forceUse: EntityHealableComponent -> Bool
...
namespace EntityHealthChangedAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.newValue"
	newValue: EntityHealthChangedAfterEvent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.oldValue"
...
namespace EntityHitBlockAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.blockFace"
	blockFace: EntityHitBlockAfterEvent -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0) => $0.damagingEntity"
	damagingEntity: EntityHitBlockAfterEvent -> Entity
	export
	%foreign "javascript:lambda: ($0) => $0.hitBlock"
...
namespace EntityHitEntityAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.hitEntity"
...
namespace EntityInventoryComponent
	export
	%foreign "javascript:lambda: ($0) => $0.additionalSlotsPerStrength"
	additionalSlotsPerStrength: EntityInventoryComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.canBeSiphonedFrom"
	canBeSiphonedFrom: EntityInventoryComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.container"
	container: EntityInventoryComponent -> Container
	export
	%foreign "javascript:lambda: ($0) => $0.containerType"
	containerType: EntityInventoryComponent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.inventorySize"
	inventorySize: EntityInventoryComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.private_"
	private_: EntityInventoryComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.restrictToOwner"
	restrictToOwner: EntityInventoryComponent -> Bool

namespace EntityItemComponent
	export
	%foreign "javascript:lambda: ($0) => $0.itemStack"
	itemStack: EntityItemComponent -> ItemStack

namespace EntityLeashableComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.leash($1)"
	leash: EntityLeashableComponent -> Entity -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.unleash()"
	unleash: EntityLeashableComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.softDistance"
...
namespace EntityMarkVariantComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityMarkVariantComponent -> Double -> PrimIO ()

namespace EntityMountTamingComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setTamed($1)"
	setTamed: EntityMountTamingComponent -> Bool -> IO ()

namespace EntityMovementGlideComponent
	export
	%foreign "javascript:lambda: ($0) => $0.speedWhenTurning"
	speedWhenTurning: EntityMovementGlideComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.startSpeed"
	startSpeed: EntityMovementGlideComponent -> Double

namespace EntityMovementSwayComponent
	export
	%foreign "javascript:lambda: ($0) => $0.swayAmplitude"
	swayAmplitude: EntityMovementSwayComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.swayFrequency"
	swayFrequency: EntityMovementSwayComponent -> Double

namespace EntityNavigationComponent
	export
	%foreign "javascript:lambda: ($0) => $0.avoidDamageBlocks"
	avoidDamageBlocks: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.avoidPortals"
	avoidPortals: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.avoidSun"
	avoidSun: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.avoidWater"
	avoidWater: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canBreach"
	canBreach: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canBreakDoors"
	canBreakDoors: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canFloat"
	canFloat: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canJump"
	canJump: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canOpenDoors"
	canOpenDoors: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canOpenIronDoors"
	canOpenIronDoors: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canPassDoors"
	canPassDoors: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canPathFromAir"
	canPathFromAir: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canPathOverLava"
	canPathOverLava: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canPathOverWater"
	canPathOverWater: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canSink"
	canSink: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canSwim"
	canSwim: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canWalk"
	canWalk: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.canWalkInLava"
	canWalkInLava: EntityNavigationComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isAmphibious"
	isAmphibious: EntityNavigationComponent -> Bool

namespace EntityOnFireComponent
	export
	%foreign "javascript:lambda: ($0) => $0.onFireTicksRemaining"
...
namespace EntityPushThroughComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityPushThroughComponent -> Double -> PrimIO ()

namespace EntityRemovedAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.removedEntity"
...
namespace EntityRideableComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addRider($1)"
	addRider: EntityRideableComponent -> Entity -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.ejectRider($1)"
	ejectRider: EntityRideableComponent -> Entity -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.ejectRiders()"
	ejectRiders: EntityRideableComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.getFamilyTypes()"
	getFamilyTypes: EntityRideableComponent -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getRiders()"
	getRiders: EntityRideableComponent -> Array_Entity
	export
	%foreign "javascript:lambda: ($0) => $0.getSeats()"
	getSeats: EntityRideableComponent -> Array_Seat
	export
	%foreign "javascript:lambda: ($0) => $0.controllingSeat"
	controllingSeat: EntityRideableComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.crouchingSkipInteract"
	crouchingSkipInteract: EntityRideableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.interactText"
	interactText: EntityRideableComponent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.pullInEntities"
	pullInEntities: EntityRideableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.riderCanInteract"
	riderCanInteract: EntityRideableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.seatCount"
	seatCount: EntityRideableComponent -> Double

namespace EntityRidingComponent
	export
	%foreign "javascript:lambda: ($0) => $0.entityRidingOn"
...
namespace EntityScaleComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntityScaleComponent -> Double -> PrimIO ()
...
namespace EntitySkinIdComponent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.value = $1"
	set_value: EntitySkinIdComponent -> Double -> PrimIO ()
...
namespace EntitySpawnAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.entity = $1"
	set_entity: EntitySpawnAfterEvent -> Entity -> PrimIO ()
...
namespace EntityStrengthComponent
	export
	%foreign "javascript:lambda: ($0) => $0.max"
...
namespace EntityTameableComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getTameItems()"
	getTameItems: EntityTameableComponent -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.tame()"
	tame: EntityTameableComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.probability"
...
namespace ExplosionAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.getImpactedBlocks()"
	getImpactedBlocks: ExplosionAfterEvent -> Array_Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.dimension"
...
namespace ExplosionBeforeEvent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setImpactedBlocks($1)"
	setImpactedBlocks: ExplosionBeforeEvent -> Array_Vector3 -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: ExplosionBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: ExplosionBeforeEvent -> Bool -> PrimIO ()
...
namespace FeedItem
	export
	%foreign "javascript:lambda: ($0) => $0.getEffects()"
	getEffects: FeedItem -> Array_FeedItemEffect
	export
	%foreign "javascript:lambda: ($0) => $0.healAmount"
...
namespace FeedItemEffect
	...
	export
	%foreign "javascript:lambda: ($0) => $0.chance"
	chance: FeedItemEffect -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.duration"
	duration: FeedItemEffect -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.name"
...
namespace ItemCompleteUseAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.useDuration"
...
namespace ItemCooldownComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.startCooldown($1)"
	startCooldown: ItemCooldownComponent -> Player -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.cooldownCategory"
	cooldownCategory: ItemCooldownComponent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.cooldownTicks"
...
namespace ItemDefinitionTriggeredAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.eventName"
	eventName: ItemDefinitionTriggeredAfterEvent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.itemStack"
	itemStack: ItemDefinitionTriggeredAfterEvent -> ItemStack
	export
	%foreign "javascript:lambda: ($0, $1) => $0.itemStack = $1"
	set_itemStack: ItemDefinitionTriggeredAfterEvent -> ItemStack -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.source"
...
namespace ItemDefinitionTriggeredBeforeEvent
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: ItemDefinitionTriggeredBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: ItemDefinitionTriggeredBeforeEvent -> Bool -> PrimIO ()

namespace ItemDurabilityComponent
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getDamageChance($1)"
	getDamageChance: ItemDurabilityComponent -> Double -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getDamageRange()"
	getDamageRange: ItemDurabilityComponent -> NumberRange
	export
	%foreign "javascript:lambda: ($0) => $0.damage"
	damage: ItemDurabilityComponent -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.damage = $1"
	set_damage: ItemDurabilityComponent -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.maxDurability"
	maxDurability: ItemDurabilityComponent -> Double

namespace ItemEnchantsComponent
	export
	%foreign "javascript:lambda: ($0) => $0.removeAllEnchantments()"
	removeAllEnchantments: ItemEnchantsComponent -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.enchantments"
	enchantments: ItemEnchantsComponent -> EnchantmentList
	export
	%foreign "javascript:lambda: ($0, $1) => $0.enchantments = $1"
	set_enchantments: ItemEnchantsComponent -> EnchantmentList -> PrimIO ()

namespace ItemFoodComponent
	export
	%foreign "javascript:lambda: ($0) => $0.canAlwaysEat"
	canAlwaysEat: ItemFoodComponent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.nutrition"
	nutrition: ItemFoodComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.saturationModifier"
	saturationModifier: ItemFoodComponent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.usingConvertsTo"
...
namespace ItemStack
	export
	%foreign "javascript:lambda: ($0,$1) => new ItemStack($1)"
	...
	export
	%foreign "javascript:lambda: ($0) => $0.getComponents()"
	getComponents: ItemStack -> Array_ItemComponent
	export
	%foreign "javascript:lambda: ($0) => $0.getLore()"
	getLore: ItemStack -> Array_String
	export
	%foreign "javascript:lambda: ($0) => $0.getTags()"
	getTags: ItemStack -> Array_String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasComponent($1)"
	hasComponent: ItemStack -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasTag($1)"
	hasTag: ItemStack -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.isStackableWith($1)"
	isStackableWith: ItemStack -> ItemStack -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setCanDestroy($1)"
	setCanDestroy: ItemStack -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setCanPlaceOn($1)"
	setCanPlaceOn: ItemStack -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setLore($1)"
	setLore: ItemStack -> Array_String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.triggerEvent($1)"
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.amount = $1"
	set_amount: ItemStack -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.isStackable"
	isStackable: ItemStack -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.keepOnDeath"
	keepOnDeath: ItemStack -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.keepOnDeath = $1"
	set_keepOnDeath: ItemStack -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.lockMode"
	lockMode: ItemStack -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0, $1) => $0.lockMode = $1"
	set_lockMode: ItemStack -> UniverseUnion -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.maxAmount"
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.nameTag = $1"
	set_nameTag: ItemStack -> String -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.type"
...
namespace ItemStartUseOnAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.blockFace"
	blockFace: ItemStartUseOnAfterEvent -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0) => $0.itemStack"
...
namespace ItemUseAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.itemStack = $1"
	set_itemStack: ItemUseAfterEvent -> ItemStack -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.source"
...
namespace ItemUseBeforeEvent
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: ItemUseBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: ItemUseBeforeEvent -> Bool -> PrimIO ()
...
namespace ItemUseOnAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.blockFace"
	blockFace: ItemUseOnAfterEvent -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0) => $0.faceLocation"
...
namespace ItemUseOnBeforeEvent
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: ItemUseOnBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: ItemUseOnBeforeEvent -> Bool -> PrimIO ()
...
namespace LeverActionAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.isPowered"
	isPowered: LeverActionAfterEvent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.player"
...
namespace MolangVariableMap
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setColorRGB($1,$2)"
	setColorRGB: MolangVariableMap -> String -> Color -> MolangVariableMap
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setColorRGBA($1,$2)"
	setColorRGBA: MolangVariableMap -> String -> Color -> MolangVariableMap
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.setSpeedAndDirection($1,$2,$3)"
	setSpeedAndDirection: MolangVariableMap -> String -> Double -> Vector3 -> MolangVariableMap
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setVector3($1,$2)"
	setVector3: MolangVariableMap -> String -> Vector3 -> MolangVariableMap

namespace NavigationResult
	export
	%foreign "javascript:lambda: ($0) => $0.getPath()"
	getPath: NavigationResult -> Array_Vector3
	export
	%foreign "javascript:lambda: ($0) => $0.isFullPath"
	isFullPath: NavigationResult -> Bool

namespace PistonActivateAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.isExpanding"
	isExpanding: PistonActivateAfterEvent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.piston"
...
namespace PistonActivateBeforeEvent
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: PistonActivateBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: PistonActivateBeforeEvent -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.isExpanding"
	isExpanding: PistonActivateBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.piston"
...
namespace Player
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addExperience($1)"
	addExperience: Player -> Double -> Double
	export
	%foreign "javascript:lambda: ($0,$1) => $0.addLevels($1)"
	addLevels: Player -> Double -> Double
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getItemCooldown($1)"
	getItemCooldown: Player -> String -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getSpawnPoint()"
	getSpawnPoint: Player -> DimensionLocation
	export
	%foreign "javascript:lambda: ($0) => $0.getTotalXp()"
	getTotalXp: Player -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.isOp()"
	isOp: Player -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.playSound($1,$2)"
	playSound: Player -> String -> PlayerSoundOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.postClientMessage($1,$2)"
	postClientMessage: Player -> String -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.resetLevel()"
	resetLevel: Player -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.sendMessage($1)"
	sendMessage: Player -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setOp($1)"
	setOp: Player -> Bool -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setSpawnPoint($1)"
	setSpawnPoint: Player -> DimensionLocation -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.startItemCooldown($1,$2)"
	startItemCooldown: Player -> String -> Double -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.camera"
	camera: Player -> Camera
	export
	%foreign "javascript:lambda: ($0) => $0.isFlying"
	isFlying: Player -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isGliding"
	isGliding: Player -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isJumping"
	...
	name: Player -> String
	export
	%foreign "javascript:lambda: ($0) => $0.onScreenDisplay"
	onScreenDisplay: Player -> ScreenDisplay
	export
	%foreign "javascript:lambda: ($0) => $0.selectedSlot"
	selectedSlot: Player -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.selectedSlot = $1"
	set_selectedSlot: Player -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.totalXpNeededForNextLevel"
	totalXpNeededForNextLevel: Player -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.xpEarnedAtCurrentLevel"
	xpEarnedAtCurrentLevel: Player -> Double
	export
	%foreign "javascript:lambda: ($0) => $0"
	getEntity : Player -> Entity

namespace PlayerJoinAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.playerId"
	playerId: PlayerJoinAfterEvent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.playerName"
...
namespace PlayerSpawnAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.initialSpawn"
	initialSpawn: PlayerSpawnAfterEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.initialSpawn = $1"
	set_initialSpawn: PlayerSpawnAfterEvent -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.player"
	player: PlayerSpawnAfterEvent -> Player
	export
	%foreign "javascript:lambda: ($0, $1) => $0.player = $1"
	set_player: PlayerSpawnAfterEvent -> Player -> PrimIO ()

namespace PressurePlatePopAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.previousRedstonePower"
	previousRedstonePower: PressurePlatePopAfterEvent -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.redstonePower"
...
namespace ProjectileHitEntityAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.getEntityHit()"
...
namespace PropertyRegistry
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.registerEntityTypeDynamicProperties($1,$2)"
	registerEntityTypeDynamicProperties: PropertyRegistry -> DynamicPropertiesDefinition -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.registerWorldDynamicProperties($1)"
	registerWorldDynamicProperties: PropertyRegistry -> DynamicPropertiesDefinition -> IO ()

namespace Scoreboard
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.addObjective($1,$2)"
	addObjective: Scoreboard -> String -> String -> ScoreboardObjective
	export
	%foreign "javascript:lambda: ($0,$1) => $0.clearObjectiveAtDisplaySlot($1)"
	clearObjectiveAtDisplaySlot: Scoreboard -> UniverseUnion -> ScoreboardObjective
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getObjective($1)"
	getObjective: Scoreboard -> String -> ScoreboardObjective
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getObjectiveAtDisplaySlot($1)"
	getObjectiveAtDisplaySlot: Scoreboard -> UniverseUnion -> ScoreboardObjectiveDisplayOptions
	export
	%foreign "javascript:lambda: ($0) => $0.getObjectives()"
	getObjectives: Scoreboard -> Array_ScoreboardObjective
	export
	%foreign "javascript:lambda: ($0) => $0.getParticipants()"
	getParticipants: Scoreboard -> Array_ScoreboardIdentity
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeObjective($1)"
	removeObjective: Scoreboard -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setObjectiveAtDisplaySlot($1,$2)"
	setObjectiveAtDisplaySlot: Scoreboard -> UniverseUnion -> ScoreboardObjectiveDisplayOptions -> ScoreboardObjective

namespace ScoreboardIdentity
	export
	%foreign "javascript:lambda: ($0) => $0.getEntity()"
	getEntity: ScoreboardIdentity -> Entity
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: ScoreboardIdentity -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.displayName"
	...
	export
	%foreign "javascript:lambda: ($0) => $0.type"
	type: ScoreboardIdentity -> UniverseUnion

namespace ScoreboardObjective
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.addScore($1,$2)"
	addScore: ScoreboardObjective -> String -> Double -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getParticipants()"
	getParticipants: ScoreboardObjective -> Array_ScoreboardIdentity
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getScore($1)"
	getScore: ScoreboardObjective -> String -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getScores()"
	getScores: ScoreboardObjective -> Array_ScoreboardScoreInfo
	export
	%foreign "javascript:lambda: ($0,$1) => $0.hasParticipant($1)"
	hasParticipant: ScoreboardObjective -> String -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: ScoreboardObjective -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeParticipant($1)"
	removeParticipant: ScoreboardObjective -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setScore($1,$2)"
...
namespace ScoreboardScoreInfo
	export
	%foreign "javascript:lambda: ($0) => $0.participant"
	participant: ScoreboardScoreInfo -> ScoreboardIdentity
	export
	%foreign "javascript:lambda: ($0) => $0.score"
	score: ScoreboardScoreInfo -> Double

namespace ScreenDisplay
	export
	%foreign "javascript:lambda: ($0) => $0.isValid()"
	isValid: ScreenDisplay -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setActionBar($1)"
	setActionBar: ScreenDisplay -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setTitle($1,$2)"
	setTitle: ScreenDisplay -> String -> TitleDisplayOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.updateSubtitle($1)"
...
namespace ScriptEventCommandMessageAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.initiator"
	initiator: ScriptEventCommandMessageAfterEvent -> Entity
	export
	%foreign "javascript:lambda: ($0) => $0.message"
	message: ScriptEventCommandMessageAfterEvent -> String
	export
	%foreign "javascript:lambda: ($0) => $0.sourceBlock"
	sourceBlock: ScriptEventCommandMessageAfterEvent -> Block
	export
	%foreign "javascript:lambda: ($0) => $0.sourceEntity"
	sourceEntity: ScriptEventCommandMessageAfterEvent -> Entity
	export
	%foreign "javascript:lambda: ($0) => $0.sourceType"
	sourceType: ScriptEventCommandMessageAfterEvent -> UniverseUnion
...
namespace Seat
	export
	%foreign "javascript:lambda: ($0) => $0.lockRiderRotation"
	lockRiderRotation: Seat -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.maxRiderCount"
	maxRiderCount: Seat -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.minRiderCount"
	minRiderCount: Seat -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.position"
...
namespace System
	export
	%foreign "javascript:lambda: ($0,$1) => $0.clearRun($1)"
	clearRun: System -> Double -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.run($1)"
	run: System -> (IO () -> IO ()) -> Double
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.runInterval($1,$2)"
	runInterval: System -> (IO () -> IO ()) -> Double -> Double
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.runTimeout($1,$2)"
	runTimeout: System -> (IO () -> IO ()) -> Double -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.afterEvents"
	afterEvents: System -> SystemAfterEvents
	export
	%foreign "javascript:lambda: ($0) => $0.beforeEvents"
	beforeEvents: System -> SystemBeforeEvents
	export
	%foreign "javascript:lambda: ($0) => $0.currentTick"
	currentTick: System -> Double

namespace SystemAfterEvents
	export
	%foreign "javascript:lambda: ($0) => $0.scriptEventReceive"
	scriptEventReceive: SystemAfterEvents -> ScriptEventCommandMessageAfterEventSignal

namespace SystemBeforeEvents
	export
	%foreign "javascript:lambda: ($0) => $0.watchdogTerminate"
...
namespace Trigger
	export
	%foreign "javascript:lambda: ($0) => new Trigger()"
	MkTrigger: String -> Trigger
	export
	%foreign "javascript:lambda: ($0) => $0.eventName"
	eventName: Trigger -> String
	export
	%foreign "javascript:lambda: ($0, $1) => $0.eventName = $1"
	set_eventName: Trigger -> String -> PrimIO ()

namespace TripWireTripAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.isPowered"
	isPowered: TripWireTripAfterEvent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.sources"
	sources: TripWireTripAfterEvent -> Array_Entity
...
namespace Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => new Vector($1,$2)"
	MkVector: Double -> Double -> Double -> Vector
	export
	%foreign "javascript:lambda: ($0,$1) => $0.equals($1)"
	equals: Vector -> Vector -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.length()"
	length: Vector -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.lengthSquared()"
	lengthSquared: Vector -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.normalized()"
	normalized: Vector -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.add($1,$2)"
	add: Vector -> Vector3 -> Vector3 -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.cross($1,$2)"
	cross: Vector -> Vector3 -> Vector3 -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.distance($1,$2)"
	distance: Vector -> Vector3 -> Vector3 -> Double
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.divide($1,$2)"
	divide: Vector -> Vector3 -> UniverseUnion -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.lerp($1,$2,$3)"
	lerp: Vector -> Vector3 -> Vector3 -> Double -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.max($1,$2)"
	max: Vector -> Vector3 -> Vector3 -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.min($1,$2)"
	min: Vector -> Vector3 -> Vector3 -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.multiply($1,$2)"
	multiply: Vector -> Vector3 -> UniverseUnion -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.slerp($1,$2,$3)"
	slerp: Vector -> Vector3 -> Vector3 -> Double -> Vector
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.subtract($1,$2)"
	...
	export
	%foreign "javascript:lambda: ($0, $1) => $0.x = $1"
	set_x: Vector -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.y"
	y: Vector -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.y = $1"
	set_y: Vector -> Double -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.z"
	z: Vector -> Double
	export
	%foreign "javascript:lambda: ($0, $1) => $0.z = $1"
	set_z: Vector -> Double -> PrimIO ()

namespace WatchdogTerminateBeforeEvent
	export
	%foreign "javascript:lambda: ($0) => $0.cancel"
	cancel: WatchdogTerminateBeforeEvent -> Bool
	export
	%foreign "javascript:lambda: ($0, $1) => $0.cancel = $1"
	set_cancel: WatchdogTerminateBeforeEvent -> Bool -> PrimIO ()
	export
	%foreign "javascript:lambda: ($0) => $0.terminateReason"
	terminateReason: WatchdogTerminateBeforeEvent -> UniverseUnion
...
namespace WeatherChangeAfterEvent
	...
	export
	%foreign "javascript:lambda: ($0) => $0.lightning"
	lightning: WeatherChangeAfterEvent -> Bool
	export
	%foreign "javascript:lambda: ($0) => $0.raining"
	raining: WeatherChangeAfterEvent -> Bool
...
namespace World
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.broadcastClientMessage($1,$2)"
	broadcastClientMessage: World -> String -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.getAbsoluteTime()"
	getAbsoluteTime: World -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getAllPlayers()"
	getAllPlayers: World -> Array_Player
	export
	%foreign "javascript:lambda: ($0) => $0.getDay()"
	getDay: World -> Double
	export
	%foreign "javascript:lambda: ($0) => $0.getDefaultSpawnLocation()"
	getDefaultSpawnLocation: World -> Vector3
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getDimension($1)"
	getDimension: World -> String -> Dimension
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getDynamicProperty($1)"
	getDynamicProperty: World -> String -> String
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getEntity($1)"
	getEntity: World -> String -> Entity
	export
	%foreign "javascript:lambda: ($0) => $0.getMoonPhase()"
	getMoonPhase: World -> UniverseUnion
	export
	%foreign "javascript:lambda: ($0,$1) => $0.getPlayers($1)"
	getPlayers: World -> EntityQueryOptions -> Array_Player
	export
	%foreign "javascript:lambda: ($0) => $0.getTimeOfDay()"
	getTimeOfDay: World -> Double
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.playMusic($1,$2)"
	playMusic: World -> String -> MusicOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2,$3) => $0.playSound($1,$2,$3)"
	playSound: World -> String -> Vector3 -> WorldSoundOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.queueMusic($1,$2)"
	queueMusic: World -> String -> MusicOptions -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.removeDynamicProperty($1)"
	removeDynamicProperty: World -> String -> Bool
	export
	%foreign "javascript:lambda: ($0,$1) => $0.sendMessage($1)"
	sendMessage: World -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setAbsoluteTime($1)"
	setAbsoluteTime: World -> Double -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setDefaultSpawnLocation($1)"
	setDefaultSpawnLocation: World -> Vector3 -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1,$2) => $0.setDynamicProperty($1,$2)"
	setDynamicProperty: World -> String -> String -> IO ()
	export
	%foreign "javascript:lambda: ($0,$1) => $0.setTimeOfDay($1)"
	setTimeOfDay: World -> Double -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.stopMusic()"
	stopMusic: World -> IO ()
	export
	%foreign "javascript:lambda: ($0) => $0.afterEvents"
...
namespace WorldInitializeAfterEvent
	export
	%foreign "javascript:lambda: ($0) => $0.propertyRegistry"
...
namespace Constant
	export
	%foreign "javascript:lambda: () => M.world"
	world : World
